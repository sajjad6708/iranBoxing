@extends('blog.layouts.master-simple')

@section('content')


<section class="vh-100 d-flex justify-content-center align-items-center pb-5">
    <form action="{{route('blog.auth.login-register')}}" method="post">
        @csrf
    <section class="login-wrapper mb-5">
        <section class="login-logo">
            <img src="{{ asset('blog-assets/images/logo/8.png') }}" alt="">
        </section>
        ...
        <section class="login-btn d-grid g-2"><button class="btn btn-danger">ورود به سایت</button></section>
